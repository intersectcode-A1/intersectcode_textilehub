...
<body class="min-h-screen flex flex-col bg-white transition-colors duration-300" x-data="{ mobileMenuOpen: false }" >
    {{-- HEADER --}}
    ...
    {{-- MAIN CONTENT --}}
    <main class="flex-grow animate-fade-in bg-white transition-colors duration-300">
        {{ $slot }}
    </main>
