            ...
            @if($item)
                <li>
                    <div class="flex items-center">
                        ...
                        @if(isset($item['url']))
                            <a href="{{ $item['url'] }}" class="ml-1 text-gray-700 hover:text-blue-600 md:ml-2 font-medium">{{ $item['name'] }}</a>
                        @else
                            <span class="ml-1 text-gray-500 md:ml-2 font-medium">{{ $item['name'] }}</span>
                        @endif
                    </div>
                </li>
            @endif
