...
@section('content')
<div class="mb-6">
    <h1 class="text-2xl font-semibold text-gray-800 dark:text-white">Kategori</h1>
...
<div class="flex justify-between items-center mb-6">
    <p class="text-lg text-gray-600 dark:text-gray-400">Kelola semua kategori produk Anda.</p>
    <a href="{{ route('categories.create') }}" class="inline-flex items-center px-6 py-3 bg-blue-600 text-white text-base font-medium rounded-xl hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 shadow-sm">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex items-center justify-end space-x-2">
                                <a href="{{ route('categories.edit', $category->id) }}" class="p-2 text-gray-500 hover:text-blue-600 bg-gray-100 hover:bg-blue-100 rounded-lg transition-all duration-200">
                    ...
                    <tr>
                        <td colspan="3" class="text-center py-12">
                            <div class="text-gray-500 dark:text-gray-400">
                                ...
                                <h3 class="mt-2 text-sm font-medium text-gray-800 dark:text-white">Tidak ada kategori</h3>
