...
@section('content')
<div class="mb-6">
    <h1 class="text-2xl font-semibold text-gray-800 dark:text-white">Tambah Supplier Baru</h1>
...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
    <form action="{{ route('supplier.store') }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <div class="mt-2">
                <input type="text" name="nama" id="nama" value="{{ old('nama') }}" class="w-full px-4 py-3 rounded-lg bg-gray-100 dark:bg-gray-700 border-2 border-gray-200 dark:border-gray-600 text-gray-800 dark:text-gray-100 placeholder-gray-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-all duration-200" required>
            </div>
            @error('nama')
        ...
        <div>
            ...
            <div class="mt-2">
                <input type="text" name="kontak" id="kontak" value="{{ old('kontak') }}" class="w-full px-4 py-3 rounded-lg bg-gray-100 dark:bg-gray-700 border-2 border-gray-200 dark:border-gray-600 text-gray-800 dark:text-gray-100 placeholder-gray-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-all duration-200" required>
            </div>
            @error('kontak')
                <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
            @enderror
        ...
        <div>
            ...
            <div class="mt-2">
                <input type="text" name="produk" id="produk" value="{{ old('produk') }}" class="w-full px-4 py-3 rounded-lg bg-gray-100 dark:bg-gray-700 border-2 border-gray-200 dark:border-gray-600 text-gray-800 dark:text-gray-100 placeholder-gray-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-all duration-200">
            </div>
            @error('produk')
                <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
            @enderror
