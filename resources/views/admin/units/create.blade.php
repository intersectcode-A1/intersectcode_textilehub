...
@section('content')
<div class="mb-6">
    <h1 class="text-2xl sm:text-3xl font-semibold text-gray-800 dark:text-white">Tambah Satuan Baru</h1>
    ...
    <form action="{{ route('units.store') }}" method="POST" class="space-y-4 sm:space-y-6">
            @csrf
                <div>
        ...
        <div class="flex flex-col sm:flex-row justify-end gap-2 sm:gap-4 pt-4">
            <a href="{{ route('units.index') }}" class="px-4 sm:px-6 py-2 sm:py-3 bg-gray-200 text-gray-800 font-semibold rounded-lg hover:bg-gray-300 transition-all duration-200 text-sm sm:text-base">
                Batal
            </a>
