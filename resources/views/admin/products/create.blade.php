...
<p class="text-lg text-gray-600 dark:text-gray-400 mb-8">Isi detail produk di bawah ini.</p>
...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-3 sm:p-6 lg:p-8">
    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4 sm:space-y-6">
        ...
        <!-- Foto -->
        <div class="border-t-2 border-gray-200 dark:border-gray-700 pt-4 sm:pt-6">
        ...
        <div class="flex flex-col sm:flex-row justify-end gap-2 sm:gap-4 pt-6 border-t-2 border-gray-200 dark:border-gray-700">
            ...
            <button type="submit" class="px-4 sm:px-6 py-2 sm:py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-all duration-200 text-sm">Tambah Produk</button>
        </div>
    </form>
</div>
@endsection
