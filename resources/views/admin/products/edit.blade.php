...
<div class="mb-4 sm:mb-6">
    <h1 class="text-2xl font-extrabold text-blue-900 dark:text-blue-200 mb-2">Edit Produk</h1>
...
<p class="text-lg text-blue-700 dark:text-blue-300 mb-8">Perbarui detail produk di bawah ini.</p>

@if(session('success'))
    <div class="mb-6 animate-fade-in-down">
        <div class="bg-gradient-to-r from-green-100 to-emerald-100 dark:from-green-900 dark:to-emerald-900 border-l-4 border-green-500 text-green-800 dark:text-green-200 p-4 rounded-xl shadow-lg flex items-center gap-3">
            <svg class="w-6 h-6 text-green-500 dark:text-green-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
            <div>
...
<div class="bg-white/70 dark:bg-gray-800/80 glass rounded-2xl shadow-2xl p-8 border border-white/20 dark:border-gray-700">
    <form action="{{ route('products.update', $data) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        @method('PUT')
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="number" name="harga" id="harga" value="{{ old('harga', $data->harga) }}"
                    class="w-full px-4 py-3 rounded-xl bg-white/60 dark:bg-gray-900 border-2 border-blue-100 dark:border-gray-700 text-blue-900 dark:text-blue-100 placeholder-blue-300 dark:placeholder-blue-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-400 focus:ring-opacity-50 transition-all duration-200 shadow-sm"
            ...
            <div>
                ...
                <input type="number" name="stok" id="stok" value="{{ old('stok', $data->stok) }}"
                    class="w-full px-4 py-3 rounded-xl bg-white/60 dark:bg-gray-900 border-2 border-blue-100 dark:border-gray-700 text-blue-900 dark:text-blue-100 placeholder-blue-300 dark:placeholder-blue-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-400 focus:ring-opacity-50 transition-all duration-200 shadow-sm"
        ...
        <div class="border-t-2 border-blue-100 dark:border-blue-900 pt-6 mt-6">
            <label for="foto" class="block text-base font-bold text-blue-900 dark:text-blue-200 mb-1">Ganti Foto Produk</label>
            <div class="mt-2 flex items-center gap-6">
                @if($data->foto)
                    <img src="{{ asset('storage/' . $data->foto) }}" alt="Preview" class="w-32 h-32 object-cover rounded-lg shadow-md">
                @else
        ...
        <!-- Varian Produk -->
        <div x-data="{ variants: {{ json_encode($data->variants) }} }" class="border-t-2 border-blue-100 dark:border-blue-900 pt-6 mt-6">
