...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Edit Kategori Pengeluaran</h1>
            <p class="text-gray-600 dark:text-gray-400 mt-1">Update kategori pengeluaran yang sudah ada</p>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Form Edit Kategori Pengeluaran</h3>
        </div>
        <div class="p-6">
            <form action="{{ route('expense-categories.update', $expenseCategory) }}" method="POST">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" id="nama" name="nama" value="{{ old('nama', $expenseCategory->nama) }}" required
                    ...
                    <div>
                        ...
                        <textarea id="deskripsi" name="deskripsi" rows="3" 
                                  ...
                                  placeholder="Deskripsi kategori pengeluaran (opsional)">{{ old('deskripsi', $expenseCategory->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
