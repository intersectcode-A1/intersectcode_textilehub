                ...
                <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ auth()->user()->name }}"
                               class="mt-1 block w-full rounded-xl border-blue-200 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        @error('name')
                    ...
                    <div>
                        ...
                        <textarea name="address" id="address" rows="3"
                                  class="mt-1 block w-full rounded-xl border-blue-200 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ auth()->user()->address }}</textarea>
                        @error('address')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="flex justify-end">
                        <button type="submit"
                                class="btn btn-primary px-8 py-3 text-base font-bold">
                            Simpan Perubahan
                        </button>
                    </div>
                </form>
