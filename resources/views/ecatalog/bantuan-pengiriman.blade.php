<x-layouts.catalog>
    <section class="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 via-white to-emerald-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 py-12 px-4">
        <div class="w-full max-w-xl mx-auto">
            <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-2xl shadow-xl dark:shadow-xl border border-blue-100 dark:border-gray-700 p-6 md:p-10 animate-fadeIn">
                ...
                <h1 class="text-3xl md:text-4xl font-extrabold text-blue-900 dark:text-white mb-2 text-center tracking-tight drop-shadow">Bantuan Pengiriman</h1>
                <p class="text-base md:text-lg text-blue-700 dark:text-gray-200 mb-8 text-center font-medium">Kami siap membantu Anda 24 jam jika mengalami kendala atau butuh informasi terkait pengiriman pesanan.</p>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div class="relative group bg-white/90 dark:bg-gray-900/80 rounded-xl border border-green-200 dark:border-green-700 shadow hover:shadow-2xl hover:-translate-y-1 transition-all duration-200 p-6 flex flex-col items-center">
                        <span class="absolute top-4 right-4 bg-green-500 text-white text-xs font-bold px-3 py-1 rounded-full shadow">24 Jam</span>
                        <div class="bg-green-100 dark:bg-green-900 rounded-full p-4 mb-3 shadow-inner">
                        ...
                        <span class="text-lg font-bold text-green-700 dark:text-green-300 mb-2">WhatsApp</span>
                        ...
                        <span class="text-xs text-gray-500 dark:text-gray-300 mt-2">Klik tombol untuk chat langsung</span>
                    </div>
                    <div class="relative group bg-white/90 dark:bg-gray-900/80 rounded-xl border border-blue-200 dark:border-blue-700 shadow hover:shadow-2xl hover:-translate-y-1 transition-all duration-200 p-6 flex flex-col items-center">
                        <span class="absolute top-4 right-4 bg-blue-500 text-white text-xs font-bold px-3 py-1 rounded-full shadow">24 Jam</span>
                        <div class="bg-blue-100 dark:bg-blue-900 rounded-full p-4 mb-3 shadow-inner">
                        ...
                        <span class="text-lg font-bold text-blue-700 dark:text-blue-300 mb-2">Telepon</span>
                        ...
                        <span class="text-xs text-gray-500 dark:text-gray-300 mt-2">Klik tombol untuk langsung menelepon</span>
                    </div>
                </div>
                <div class="mt-8">
                    <div class="flex items-center gap-2 mb-2">
                        ...
                        <span class="font-bold text-blue-700 dark:text-blue-300">Jam Layanan:</span>
                        <span class="text-gray-700 dark:text-gray-200">24 Jam / 7 Hari</span>
                    </div>
                    <div class="mt-4">
                        <h2 class="text-lg font-bold text-blue-900 dark:text-white mb-2">FAQ</h2>
                        <ul class="list-disc pl-6 text-gray-700 dark:text-gray-200 space-y-1">
