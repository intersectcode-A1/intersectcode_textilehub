<x-layouts.catalog>
    <section class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div class="text-center max-w-2xl mx-auto mb-10">
                            <h1 class="text-3xl sm:text-4xl font-extrabold text-blue-900 mb-2">Status Pemesanan</h1>
                <p class="text-lg text-blue-700">Pantau status pesanan yang sedang diproses</p>
        </div>
                            ...
                            <tr class="hover:bg-blue-50 transition-all duration-150">
                                ...
                                <td class="px-6 py-3 whitespace-nowrap">
                                    <span class="px-3 py-1 inline-flex items-center text-xs leading-5 font-bold rounded-full shadow animate-fade-in
                                        @if($order->status === 'pending') bg-blue-100 text-blue-700 border border-blue-200
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-8 text-center">
                                    <div class="flex flex-col items-center justify-center gap-2">
                                        ...
                                        <span class="text-blue-400 font-semibold">Tidak ada pesanan</span>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
